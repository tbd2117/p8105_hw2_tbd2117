...
sports_balls_2017 = 
  bind_rows(mr_trash_df, professor_trash_df, captain_trash_df) %>% 
...
Trash Wheel. The dataset has 51 rows and 14 columns, and includes data
for dumpsters from 2017 to 2019.

The *captain\_trash\_df* contains data on trash collected by Captain
Trash Wheel. The dataset has 9 rows and 11 columns, and includes data
